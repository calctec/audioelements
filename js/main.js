(function($) {
  ...
  ---------------------*/
    $(".audio-tab").click(function(){
      $(".inactive-audio-img").hide();
      $(".active-audio-img").show();
      $(".inactive-video-img").show();
      $(".active-video-img").hide();
    })
    $(".video-tab").click(function(){
      $(".inactive-audio-img").show();
      $(".active-audio-img").hide();
      $(".inactive-video-img").hide();
      $(".active-video-img").show();
    });
   /*--------------------
    Brand Partners
  ---------------------*/
